	...
	<div class="row clearfix">
		<div class="col-md-7 column">
			<div class="page-header">
			  <h1>渲染文件上传服务 <small>Render Server</small></h1>
			</div>
...
//		extFilters: [".txt", ".gz", ".jpg", ".png", ".jpeg", ".gif", ".avi", ".html", ".htm"], /** 默认是全部允许，即 [] */
		...
		tokenURL : "${pageContext.request.contextPath}/tk", /** 根据文件名、大小等信息获取Token的URI（用于生成断点续传、跨域的令牌） */
		frmUploadURL : "${pageContext.request.contextPath}/fd;", /** Flash上传的URI */
		uploadURL : "${pageContext.request.contextPath}/upload", /** HTML5上传的URI */
